def content(makeFns):
	...
	wp("Также предварительно (без данных для построения этих файлов) доступны аналогичные файлы для проекта закона о бюджете 2015 года:")
	wDownloadFileList((
		...
		("departments2014-2017.xlsx","Ведомственная структура расходов бюджета Санкт-Петербурга (по законам 2014 и 2015 годов)"),
		("sections2014-2017.xlsx","Распределение бюджетных ассигнований бюджета Санкт-Петербурга (по законам 2014 и 2015 годов)"),
	))
	wp(
		"Соответствие целевых статей между законами 2014 и 2015 годов частично выполнено вручную и доступно для просмотра "+
		ae("https://github.com/AntonKhorev/spb-budget-db/blob/master/3-db/categoryNameTranslations.txt","здесь")+
		" (нечётная строка = было, чётная = стало)."
	)
	wp(
